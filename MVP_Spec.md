# Open Eppic — MVP Specification (v1.1)
...
13. **Perpetual licensing: undecided but immensely core.** Likely form: perpetual license restricted to the platform, granted to sub-creators. Exact form to be worked out; flag it in all schema/infra decisions so nothing forecloses it.
...
- **Transparency log detailed shape** — moderation-outcome table schema, public view/RLS design, report generation format and cadence. Resolves Locked Decision 16's implementation. To be worked out in Roadmap.md Phase 0.
